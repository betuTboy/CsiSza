...
class Options:
    ...
    def __init__(self):
        ...
        self.height = 17
        self.timelimit = 30
        self.aitimelimit = [30, 30, 30]

        self.wordlengthlist = [['True', 'True', 'True', 'True', 'True', 'True', 'True', 'True', 'True', 'True'],
                               ['True', 'True', 'True', 'True', 'True', 'True', 'True', 'True', 'True', 'True'],
                               ['True', 'True', 'True', 'True', 'True', 'True', 'True', 'True', 'True', 'True']]
        self.aidictionarylimited = ["20000 >", "20000 >", "20000 >"]
        self.aistrength = [100, 100, 100]
